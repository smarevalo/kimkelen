...
<div class="certificate-wrapper">
	<div class="report-content">
		...
		<div style="float:left; margin-left: 90px; margin-top: 85px;">SELLO</div>
...
<div class="certificate-wrapper">
	...
	<div class="report-content">
		...
		<?php include_partial('certificate_header');?>
		<div class="report-text">
			<?php include_partial('certificate_escolaridad_text',array('student'=> $student));?>
			<?php include_partial('certificate_escolaridad_footer_text');?>
		</div>
