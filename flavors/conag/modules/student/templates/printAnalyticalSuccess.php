...
<div class="report-wrapper"> 
    ...
    <div class="analytical"> 
        <?php include_partial("analytical_header", array('career_student' => $career_student, 'analytical' => $analytical, 'analytic' => $analytic,'dipregep_number' => $dipregep_number, 'matriz' => $matriz, 'folio' => $folio, 'cue' => $cue, 'egreso' => $egreso)) ?>
        <div class="report-content">
            <?php include_component('student', 'component_analytical_table', array('career_student' => $career_student)) ?>
        </div>
        <?php include_partial('analytical_footer', array('career_student' => $career_student, 'analytical' => $analytical,'analytic' => $analytic , 'matriz' => $matriz, 'folio' => $folio, 'cue' => $cue, 'egreso' => $egreso)) ?>
    </div>
