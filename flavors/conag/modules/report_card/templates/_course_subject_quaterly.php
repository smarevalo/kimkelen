...
<?php $max_marks = 0 ?>
<?php $totalPrimero=0;$totalSegundo=0;$cantidadMaterias=0;?>
...
<?php /*MUESTRA EL PROMEDIO DE CADA CUATRIMESTRE*/?>


<div class="report-average"><?php echo "  PROMEDIO 1C : " . number_format( $totalPrimero/($cantidadMaterias/2),2,'.','.')?></div>
<div class="report-average"><?php echo "  PROMEDIO 2C : " . number_format( $totalSegundo/($cantidadMaterias/2),2,'.','.')?></div>
