...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body onLoad="setFontSize()">
    ...
    <div id="wrapper">
      <div id="header">
       <div class="logo">
         <?php echo link_to(image_tag("logo-CoNAg.png", array('alt' => __('Sistema Alumnos - CoNAg'))), '@homepage', array('title' => __('Ir al inicio'))) ?>

	       <?php $school_year = SchoolYearPeer::retrieveCurrent(); ?>
	       <?php if ($school_year): ?>
		       <div id="header-school-year">
			       <?php echo __("<b>&nbsp&nbsp&nbsp&nbspAño lectivo vigente: %%school_year%% </b>", array('%%school_year%%' => $school_year)); ?>
		       </div>
	       <?php endif; ?>
       </div>
      ...
      <div id="footer">
        ...
        © <?php echo date('Y');?> | CoNAg-UNdeC | <?php echo sfConfig::get('app_version_number') ?>
      </div><!-- end footer -->
    </div> <!-- end wrapper -->
  </body>
</html>